...
#   docker run -p 127.0.0.1:8787:8787 -v codec-data:/data --env-file /private/path/codec.env codec
#
...
FROM alpine:3.24.2
RUN adduser -D -u 1000 codec && mkdir -p /data && chown codec:codec /data
